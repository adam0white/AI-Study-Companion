/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 55b3adef61e60702f18486a92284b0e6)
// Runtime types generated with workerd@1.20251105.0 2025-11-07 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "StudentCompanion";
	}
	interface Env {
		VITE_CLERK_PUBLISHABLE_KEY: "pk_test_YmVjb21pbmctcmFiYml0LTYwLmNsZXJrLmFjY291bnRzLmRldiQ";
		CLERK_PUBLISHABLE_KEY: string;
		CLERK_SECRET_KEY: string;
		COMPANION: DurableObjectNamespace<import("./src/worker").StudentCompanion>;
		R2: R2Bucket;
		DB: D1Database;
		AI: Ai;
		ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY">> {}
}
